...
app.post("/", zValidator("json", CreateCodeSchema), (c) => {
...
app.get("/:code", zValidator("param", CodeSchema), (c) => {
...
app.delete("/:code", zValidator("param", CodeSchema), (c) => {
  const { code } = c.req.valid("param");
...
app.get("/guild/:guildId", zValidator("param", GuildIdSchema), (c) => {
